...
function initMap() {
    let losAngles= { lat: 40.267164, lng: -83.070894}
            ...
            <div class="store-container">
                <div class="store-container-background">
                    <div class="store-info-container">
                        ...
                        <div class="store-phone-number">${store.phoneNumber}
...
const createMarker = (latlng, name, address, phone,  openStatusText, storeNumber) => {
    let html = `
